...
class UserProfileService {
    ...
    updateProfile(data, user_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (updateProfile) {
                ...
                yield profileCommunicationProvide._init__(process.env.AUTH_DATA_UPDATE_QUEUE || "");
    ...
    updatePhoneNumber(newPhoneNumber, user_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (findUser) {
                ...
                const otpTimer = const_1.default.MINIMUM_OTP_TIMER();
    ...
    updateEmailId(newEmailId, user_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (findUser) {
                ...
                yield profileProivider._init__(process.env.EMAIL_PROFILE_UPDATE_OTP || "");
    ...
    validateUpdateProfileOTP(otp_number, type, user_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const userData = yield this.userRepo.findUserByUserId(user_id); //UserProfileModel.findOne({ user_id });
            if (userData) {
